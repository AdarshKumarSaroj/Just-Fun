...
def create_ppt(text_file, design_number, ppt_name):
    prs = Presentation(f"C:/Users/SATYAM/Desktop/PPTX/Designs/Design-{design_number}.pptx")
    slide_count = 0
    header = ""
    content = ""
    ...
    prs.save(f'C:/Users/SATYAM/Desktop/PPTX/GeneratedPresentations/{ppt_name}.pptx')
    file_path = f"C:/Users/SATYAM/Desktop/PPTX/GeneratedPresentations/{ppt_name}.pptx"
...
def get_bot_response(msg):
    ...
    with open(f'C:/Users/SATYAM/Desktop/PPTX/Cache/{input_string}.txt', 'w', encoding='utf-8') as f:
        f.write(create_ppt_text(input_string))

    pptlink = create_ppt(f'C:/Users/SATYAM/Desktop/PPTX/Cache/{input_string}.txt', number, input_string)
    return str(pptlink)
